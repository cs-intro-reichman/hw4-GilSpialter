...
public class ArrCharOps {
    ...
    */
     ...
     *         return -2 if there is an error with the input.                          //what is considered an error with the input?
     */
    public static int compareTo(String str1, String str2) {
        ...
        if (str1.length() < str2.length()) return -1;   //i only reach this code if all values are equal until the end of a string.
        if (str1.length() > str2.length()) return 1;    //meaning alpahbetically they are equal. length is now the only determinant.
        return 0;
    }
}
